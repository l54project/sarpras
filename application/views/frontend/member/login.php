        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <h1 class="h2 text-gray-900 mb-4"><strong>LOGIN PEMINJAM</strong></h1>
                        <h2 class="h4 text-gray-900 mb-4"><strong>SARPRAS SMK KESUMA</strong></h2>                    </div>
                        ...
                        <form action="do_login" method="post" role="form" id="login-form">
                          <div role="alert" class="alert alert-success hidden">
                            ...
                            <fieldset>
                                ...
                                <button class="btn btn-lg btn-primary btn-block"><i class="fa fa-key"></i> LOGIN</button>
                            </fieldset>
                        </form>
                    </div>
