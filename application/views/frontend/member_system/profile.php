<div class="row">
		<div class="col-lg-12">
				<h1 class="page-header"><strong>Anda Login Sebagai</strong></h1>
		</div>
		<!-- /.col-lg-12 -->
</div>
...
<!--				-------------------------------------------------------------------------------------------------------->
				...
				<div class="form-group">
					...
					<div class="col-md-2 col-xs-12">
						<input type="text" name="" class="form-control" value="<?php echo $data->status; ?>" disabled>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-md-1 col-xs-12 control-label">Telepon</label>
					<div class="col-md-3 col-xs-12">
						<input type="text" name="" class="form-control" value="<?php echo $data->telepon; ?>" disabled>
					</div>
				</div>
