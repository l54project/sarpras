<div class="row">
		<div class="col-lg-12">
				<h1 class="page-header"><strong>Form Data Petugas</strong></h1>
		</div>
		<!-- /.col-lg-12 -->
</div>
			...
			<div class="panel panel-default">
				...
				<form class="form-horizontal" method="POST" id="petugas_form" action="<?php if($data!=null) echo base_url('admin_system/petugas_update'); else echo base_url('admin_system/petugas_add'); ?>">
...
<!--				-------------------------------------------------------------------------------------------------------->
				<div class="form-group">
					...
					<div class="col-md-2 col-xs-12">
						<input type="text" class="form-control" value="<?php if($data!=null) echo $data->id_petugas; else echo'AUTO' ?>" disabled>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-2 col-xs-12">
						<input type="text" name="telepon" class="form-control" value="<?php if($data!=null) echo $data->telepon; ?>" >
					</div>
				</div>
				</div>
