<div class="row">
		<div class="col-lg-12">
				<h1 class="page-header"><strong>Form Data Peminjam</strong></h1>
		</div>
		<!-- /.col-lg-12 -->
</div>
...
<!--				-------------------------------------------------------------------------------------------------------->
				...
				<div class="form-group">
					...
					<div class="col-md-2 col-xs-12">
						<input type="text" name="username" class="form-control" placeholder="Username" value="<?php if($data!=null) echo $data->username; ?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-xs-12 control-label">Password</label>
					<div class="col-md-2 col-xs-12">
						<input type="text" name="password" class="form-control" placeholder="Password" value="<?php if($data!=null) echo $this->encrypt->decode($data->password); ?>">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-3 col-xs-12">
						<input type="text" name="status" class="form-control" placeholder="Jabatan atau Kelas" value="<?php if($data!=null) echo $data->status; ?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-xs-12 control-label">Email</label>
					<div class="col-md-3 col-xs-12">
						<input type="text" name="email" class="form-control" placeholder="Email" value="<?php if($data!=null) echo $data->email; ?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-xs-12 control-label">Telepon</label>
					<div class="col-md-2 col-xs-12">
						<input type="text" name="telepon" class="form-control" placeholder="No Telepon"  value="<?php if($data!=null) echo $data->telepon; ?>">
					</div>
				</div>
