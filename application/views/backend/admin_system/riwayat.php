            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><strong>Riwayat Peminjaman</strong></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="text-right">
                      <div class="pull-left panel-title">Riwayat Peminjaman Barang</div>
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <a class="btn btn-primary btn-add" href="<?php echo base_url('admin_system/riwayat_print') ?>"><i class="fa fa-print"></i></a>
                          <a class="btn btn-danger btn-add" href="<?php echo base_url('admin_system/riwayat_clear') ?>"><i class="fa fa-times"></i> Clear</a>
                         </div>
