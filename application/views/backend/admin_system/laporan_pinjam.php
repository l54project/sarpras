            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><strong>Barang Dipinjam</strong></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <div class="text-right">
                      ...
                      <a class="btn btn-primary btn-add" href="<?php echo base_url('admin_system/laporan_print') ?>"><i class="fa fa-print"></i></a>
