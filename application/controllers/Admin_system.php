...
class Admin_system extends PX_Controller {
	...
	function petugas_add(){
		...
		$check_username = $this->model_basic->select_where('tbl_petugas','username',$insert['username'])->row();
	...
	function petugas_update(){
		...
		$check_username = $this->model_basic->select_where('tbl_petugas','username',$update['username'])->row();
		if ($check_username != null && $check_username->id_petugas != $update['id_petugas']) {
			$this->returnJson(array('status' => 'error','msg' => 'Username sudah digunakan!'));
		}else{
			if($update){
	...
	function pinjam(){
		$this->check_login_petugas();
		$data['userdata'] = $this->session_petugas;
		$data['data'] = $this->model_basic->select_where_join_2('tbl_pinjam','tbl_pinjam.*,tbl_barang.name as name_barang,tbl_peminjam.name as name_peminjam,tbl_peminjam.status as jabatan','tbl_pinjam.status','0','tbl_barang','tbl_pinjam.id_barang','tbl_barang.id_barang','tbl_peminjam','tbl_pinjam.id_peminjam','tbl_peminjam.id_peminjam')->result();
	...
	function kembali(){
		$this->check_login_petugas();
		$data['userdata'] = $this->session_petugas;
		$data['data'] = $this->model_basic->select_where_join_2('tbl_pinjam','tbl_pinjam.*,tbl_barang.name as name_barang,tbl_peminjam.name as name_peminjam,tbl_peminjam.status as jabatan','tbl_pinjam.status','2','tbl_barang','tbl_pinjam.id_barang','tbl_barang.id_barang','tbl_peminjam','tbl_pinjam.id_peminjam','tbl_peminjam.id_peminjam')->result();
	...
	function riwayat(){
		$this->check_login_petugas();
		$data['userdata'] = $this->session_petugas;
		$data['data'] = $this->model_basic->select_all_join_2('tbl_riwayat','tbl_riwayat.*,tbl_barang.name as name_barang,tbl_peminjam.name as name_peminjam,tbl_peminjam.status as jabatan','tbl_barang','tbl_riwayat.id_barang','tbl_barang.id_barang','tbl_peminjam','tbl_riwayat.id_peminjam','tbl_peminjam.id_peminjam');
	...
	function laporan_pinjam(){
		$this->check_login_petugas();
		$data['userdata'] = $this->session_petugas;
		$data['data'] = $this->model_basic->select_where_join_2('tbl_pinjam','tbl_pinjam.*,tbl_barang.name as name_barang,tbl_peminjam.name as name_peminjam,tbl_peminjam.status as jabatan','tbl_pinjam.status','1','tbl_barang','tbl_pinjam.id_barang','tbl_barang.id_barang','tbl_peminjam','tbl_pinjam.id_peminjam','tbl_peminjam.id_peminjam','tbl_peminjam.status')->result();
	...
	function laporan_print(){
		$data['data'] = $this->model_basic->select_where_join_2('tbl_pinjam','tbl_pinjam.*,tbl_barang.name as name_barang,tbl_peminjam.name as name_peminjam,tbl_peminjam.status as jabatan','tbl_pinjam.status','1','tbl_barang','tbl_pinjam.id_barang','tbl_barang.id_barang','tbl_peminjam','tbl_pinjam.id_peminjam','tbl_peminjam.id_peminjam','tbl_peminjam.status')->result(); 
		$this->load->view('backend/admin_system/laporan_print', $data);
	}

	function riwayat_print(){
		$data['data'] = $this->model_basic->select_all_join_2('tbl_riwayat','tbl_riwayat.*,tbl_barang.name as name_barang,tbl_peminjam.name as name_peminjam,tbl_peminjam.status as jabatan','tbl_barang','tbl_riwayat.id_barang','tbl_barang.id_barang','tbl_peminjam','tbl_riwayat.id_peminjam','tbl_peminjam.id_peminjam');
		$this->load->view('backend/admin_system/riwayat_print', $data);
	}
